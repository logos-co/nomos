...
use nomos_mempool::{
    MempoolMsg, TxMempoolService, backend::pool::Mempool, network::NetworkAdapter,
};
...
where
    ...
    StorageAdapter: nomos_mempool::storage::MempoolStorageAdapter<RuntimeServiceId, Key = Key, Item = Item>
        + Clone
        + 'static,
