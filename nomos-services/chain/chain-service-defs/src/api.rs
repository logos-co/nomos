...
pub trait CryptarchiaServiceData:
    ServiceData<
        Message = ConsensusMsg<nomos_core::block::Block<nomos_core::mantle::SignedMantleTx>>,
    > + Send
    + 'static
{
}
impl<T> CryptarchiaServiceData for T where
    T: ServiceData<
            Message = ConsensusMsg<nomos_core::block::Block<nomos_core::mantle::SignedMantleTx>>,
        > + Send
        + 'static
    ...
    RuntimeServiceId: AsServiceId<Cryptarchia> + std::fmt::Debug + std::fmt::Display + Sync,
{
    ...
    pub async fn subscribe_blocks(
        ...
        broadcast::Receiver<nomos_core::block::Block<nomos_core::mantle::SignedMantleTx>>,
        String,
    > {
