...
use nomos_blend_scheduling::{
    ...
    session::{FirstImmediateStream, SessionEvent, SessionEventStream},
};
...
) -> FirstImmediateStream<impl Stream<Item = SessionEvent<Membership<NodeId>>>>
where
    NodeId: Clone + Send + Sync + 'static,
{
    FirstImmediateStream::new(SessionEventStream::new(
