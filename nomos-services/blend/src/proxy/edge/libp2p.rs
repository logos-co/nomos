...
use crate::{
    ...
    edge::{backends::libp2p::Libp2pBlendEdgeBackend, BlendEdgeService},
...
type BlendServiceType<RuntimeServiceId> = BlendEdgeService<
    Libp2pBlendEdgeBackend,
    PeerId,
...
impl<RuntimeServiceId> Adapter<RuntimeServiceId> for Libp2pAdapter<RuntimeServiceId> {
    type Backend = Libp2pBlendEdgeBackend;
