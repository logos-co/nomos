...
// #[test_log::test(tokio::test)]
// #[should_panic(
//     expected = "The initial membership should satisfy the edge node
// condition: NetworkIsTooSmall" )]
...
//     .await;
//
//     // Send a new session with an empty membership (smaller than the min
// size).     session_sender
