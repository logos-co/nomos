    ...
    Network: NetworkAdapter<RuntimeServiceId>,
{
    ...
    type Message = ServiceMessage<crate::message::ServiceMessage<Network::BroadcastSettings>>;
}
...
async fn handle_service_message<
    ...
    RuntimeServiceId,
>(
    message: ServiceMessage<crate::message::ServiceMessage<BroadcastSettings>>,
    ...
    ProofsGenerator: CoreAndLeaderProofsGenerator,
{
    match message {
        ...
        ServiceMessage::FinishSessionTransitionPeriod { reply_sender } => {
            handle_finish_session_transition_period_message(blending_token_collector, reply_sender);
        }
    }
}
...
async fn handle_local_data_message<
    ...
    RuntimeServiceId,
>(
    local_data_message: crate::message::ServiceMessage<BroadcastSettings>,
    cryptographic_processor: &mut CoreCryptographicProcessor<
        NodeId,
        ProofsGenerator,
        ProofsVerifier,
    ...
    ProofsGenerator: CoreAndLeaderProofsGenerator,
{
    let crate::message::ServiceMessage::Blend(message_payload) = local_data_message;
...
fn handle_finish_session_transition_period_message(
    blending_token_collector: &mut BlendingTokenCollector,
