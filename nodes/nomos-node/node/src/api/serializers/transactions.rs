use nomos_core::{
    mantle::{MantleTx, Op, OpProof, SignedMantleTx, TxHash, gas::Gas, ledger::Tx as LedgerTx},
    proofs::zksig::DummyZkSignature as ZkSignature,
};
use serde::Serialize;
...
pub struct ApiTransactionSerializer {
    #[serde(getter = "<MantleTx as nomos_core::mantle::Transaction>::hash")]
    hash: TxHash,
    ops: Vec<Op>,
    ledger_tx: LedgerTx,
