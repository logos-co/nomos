...
use nomos_time::{TimeServiceSettings, backends::NtpTimeBackendSettings};
...
impl ServiceConfig {
    ...
    pub fn into_time_service_settings(
        ...
        TimeServiceSettings {
            ...
            epoch_config: cryptarchia_deployment.ledger.epoch_config,
            base_period_length: cryptarchia_deployment.ledger.base_period_length(),
